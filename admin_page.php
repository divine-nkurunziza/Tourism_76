              ...
              <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                      <h5 class="card-title text-center pb-0 fs-4">Admin Page</h5>
                      <p class="text-center Large">Welcome to Admin Page! <br>You can view update information</p>
                    </div>



                    <div class="col-12">
                        <p class="small mb-0">Add Sites >> <a href="places.php"> Use this page</a></p>
                      </div>

                      <div class="col-12">
                        <p class="small mb-0">Update Sites>><a href="sites_update.php">Sites</a></p>
                      </div>
                      ...
                      <div class="col-12">
                        <p class="small mb-0">Done?<a href="index.php">Log out</a></p>
                      </div>
