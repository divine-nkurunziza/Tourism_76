...
<head>
  ...
  <title>MIDZO - Administrator</title>
                  ...
                  <form method="POST" class="row g-3" action=" ">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email_adm" class="form-control" id="yourpass" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password_adm" class="form-control" id="yourpass" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="login_adm">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Login in a user? <a href="login.php">Login</a></p>
                    </div>
                  </form>
